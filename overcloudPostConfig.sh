...
externalCidr='192.168.251.0/24'
externalGateway='192.168.251.1'
externalDns='156.26.250.22'
externalFipStart='192.168.251.70'
externalFipEnd='192.168.251.199'
tenantNetwork=private
tenantCidr='10.10.0.0/24'
keypairName=operator
keypairPubkey="ssh-rsa "
...
neutron net-create $externalNetwork --provider:network_type vlan --provider:segmentation_id 973 --provider:physical_network datacentre --shared --router:external 
